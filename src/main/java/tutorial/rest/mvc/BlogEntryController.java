...
public class BlogEntryController {
    ...
    public ResponseEntity<BlogEntryResource> getBlogEntry(@PathVariable Long blogEntryId) {
        BlogEntry entry = service.findBlogEntry(blogEntryId);
        if (entry != null) {
            BlogEntryResource resourse = new BlogEntryResourceAsm().toResource(entry);
            return new ResponseEntity<BlogEntryResource>(resourse, HttpStatus.OK);
        } else return new ResponseEntity<BlogEntryResource>(HttpStatus.NOT_FOUND);
    }
